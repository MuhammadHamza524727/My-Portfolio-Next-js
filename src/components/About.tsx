...
const About = () => {
  return (
    <div id='about' className='container pt-32 '>
      <h2 className='text-4xl md:text-5xl'  data-aos="fade-right">About Me</h2>
      <p className='text-gray-500 pt-4'  data-aos="fade-right" >
      ...
      Combining cutting-edge AI techniques with immersive Metaverse experiences, I'm exploring the intersection of technology and human interaction.
